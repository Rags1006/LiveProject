...
public class Homepage extends BasePage{
	...
	By homePageLink=By.xpath("//a[text()='Homepage']");
	By accordionLink=By.xpath("//a[text()='Accordion']");
	By actionsLink=By.xpath("//a[text()='Actions']");
	By browserTabsLink=By.xpath("//a[text()='Browser Tabs']");
